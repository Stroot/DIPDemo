...
CDlgLinerPara::CDlgLinerPara ( CWnd*
                               pParent /*=NULL*/ )
...
void CDlgLinerPara::DoDataExchange (
    CDataExchange* pDX )
{
...
void CDlgLinerPara::OnLButtonDown ( UINT nFlags,
                                    CPoint point )
{
    // 当用户单击鼠标左键开始拖动
...
void CDlgLinerPara::OnMouseMove ( UINT nFlags,
                                  CPoint point )
{
    // 判断当前光标是否在绘制区域
    if ( m_MouseRect.PtInRect ( point ) )
